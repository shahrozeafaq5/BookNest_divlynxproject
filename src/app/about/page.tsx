...
export default function AboutPage() {
  ...
  return (
    <section className="relative px-4">
      ...
      >
        <motion.h1 variants={fadeInUp} className="font-scripture text-7xl md:text-9xl tracking-tighter text-[#2B2A28]">
          01
        </motion.h1>
        <div className="overflow-hidden">
          <motion.h2 variants={fadeInUp} className="font-serif italic text-4xl md:text-7xl text-[#2B2A28] mb-4 tracking-tight">
            The Philosophy
          </motion.h2>
          <motion.p variants={fadeInUp} className="font-body text-[#8B6F47] uppercase tracking-[0.5em] text-[10px] font-bold">
      ...
      <div className="grid lg:grid-cols-12 gap-20 items-start">
        ...
        >
          <Image
            ...
            alt="Classical Library Stacks"
            fill
            className="object-cover grayscale group-hover:grayscale-0 transition-all duration-[2s] ease-out scale-110 group-hover:scale-100"
          />
      ...
      {/* ─── QUOTE SECTION: SEAMLESS INTEGRATION ─── */}
      <motion.div 
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 1.5, ease: "easeOut" }}
        viewport={{ once: true }}
        className="mt-60 text-center py-72 relative overflow-hidden border-y border-[#8B6F47]/10 min-h-[700px] flex items-center justify-center bg-[#FDFCF8]"
      >
        {/* BACKGROUND IMAGE LAYER */}
        <div className="absolute inset-0 z-0">
          <Image
            src="https://images.unsplash.com/photo-1532012197267-da84d127e765?q=80&w=2000"
            alt="Aged books background"
            fill
            className="object-cover opacity-20 grayscale-[20%] contrast-[1.1] sepia-[20%]"
          />
          {/* AGGRESSIVE RADIAL & LINEAR OVERLAYS 
              Using from-0% to-100% with middle stops creates a massive fade-out 
          */}
          <div className="absolute inset-0 bg-gradient-to-b from-[#FDFCF8] from-0% via-transparent via-50% to-[#FDFCF8] to-100%" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#FDFCF8] from-0% via-transparent via-50% to-[#FDFCF8] to-100%" />
          
          {/* Radial mask for extra focus in the center */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,#FDFCF8_80%)]" />
        </div>

        {/* QUOTE CONTENT */}
        <div className="relative z-20 px-6">
          <p className="font-serif italic text-4xl md:text-7xl text-[#2B2A28] max-w-5xl mx-auto leading-[1.1] tracking-tighter drop-shadow-sm">
          ...
          <motion.div 
            ...
            className="h-px bg-[#8B6F47] mx-auto mt-16 opacity-60"
          />
        </div>
      </motion.div>
    </section>
